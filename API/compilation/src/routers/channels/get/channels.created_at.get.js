...
exports.getChannelCreatedAt = void 0;
const controller_1 = require("../../controller");
const database_1 = __importDefault(require("../../../database"));
const utils_1 = __importDefault(require("../../../utils"));
const getChannelCreatedAt = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.getChannelCreatedAt = getChannelCreatedAt;
